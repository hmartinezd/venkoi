...
import type { ServeVisualLabels } from '@/lib/serve-visual-labels';

export type { ServeVisualLabels } from '@/lib/serve-visual-labels';
...
const inventoryRows = (l: ServeVisualLabels) => [
...
function Frame({ l, children, className = '', tone = 'light' }: { l: ServeVisualLabels; children: React.ReactNode; className?: string; tone?: PreviewTone }) {
...
function Inventory({ l }: { l: ServeVisualLabels }) {
...
function Purchases({ l }: { l: ServeVisualLabels }) {
...
function Activity({ l }: { l: ServeVisualLabels }) {
...
function Costs({ l }: { l: ServeVisualLabels }) {
...
function Counts({ l }: { l: ServeVisualLabels }) {
  const rows = [
...
export function ServeProductVisual({ type, className = '', labels: l }: Props) {
